...
[assembly: CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttribute("1.0.61214.0829", "CodeFluent Entities generated (http://www.softfluent.com). Date: Wednesday, 11 No" +
    "vember 2015 01:11.", CodeFluent.Runtime.Utilities.CodeFluentGeneratedAttributeOptions.CompiledWithVisualStudio, 25137776u)]

namespace TennisClubLadder.Resources
{
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("TennisClubLadder.TennisClubLadder", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static TennisClubLadder.Resources.ValueValidationFailureHandler _current = new TennisClubLadder.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static TennisClubLadder.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return TennisClubLadder.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = TennisClubLadder.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace TennisClubLadder
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string TennisClubLadderStoreName = "TennisClubLadder";
