...
namespace Users
{
    ...
    public partial class UserClaim : System.ICloneable, System.IComparable, System.IComparable<Users.UserClaim>, CodeFluent.Runtime.ICodeFluentCollectionEntity<int>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<Users.UserClaim>
    {
        ...
        public virtual bool Equals(Users.UserClaim userClaim)
        {
            if ((userClaim == null))
            {
                return false;
        ...
        public override bool Equals(object obj)
        {
			...
			userClaim = obj as Users.UserClaim;
...
userClaim = value as Users.UserClaim;
        ...
        public virtual int CompareTo(Users.UserClaim userClaim)
        {
            if ((userClaim == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = TennisClubLadder.Resources.Manager.GetStringWithDefault(culture, "Users.UserClaim.ExternalValidate", "Type \'Users.UserClaim\' cannot be validated.", null);
                }
            ...
            {
                string localValidate = TennisClubLadder.Resources.Manager.GetStringWithDefault(culture, "Users.UserClaim.Type.NullException", "\'Type\' property cannot be set to \'\' for type \'Users.UserClaim\'", null);
                CodeFluentPersistence.AddValidationError(results, localValidate);
            }
            if ((this.User == null))
            {
                string localValidate1 = TennisClubLadder.Resources.Manager.GetStringWithDefault(culture, "Users.UserClaim.User.NullException", "\'User\' property cannot be set to \'\' for type \'Users.UserClaim\'", null);
        ...
        public virtual bool Delete()
        {
            ...
            persistence.AddParameter("@UserClaim_Id", this.Id, ((int)(-1)));
        ...
        protected virtual void ReadRecord(System.Data.IDataReader reader, CodeFluent.Runtime.CodeFluentReloadOptions options)
        {
            ...
            if ((((options & CodeFluent.Runtime.CodeFluentReloadOptions.Properties) 
                        ...
                        == false))
            {
                this._id = CodeFluentPersistence.GetReaderValue(reader, "UserClaim_Id", ((int)(-1)));
                ...
                this.UserId = CodeFluentPersistence.GetReaderValue(reader, "UserClaim_User_Id", ((int)(-1)));
            }
        ...
        public static Users.UserClaim Load(int id)
        {
            if ((id == -1))
            {
                return null;
        ...
        public static Users.UserClaim LoadById(int id)
        {
            if ((id == -1))
            {
                return null;
        ...
        protected virtual bool BaseSave(bool force)
        {
            ...
            persistence.AddParameter("@UserClaim_User_Id", this.UserId, ((int)(-1)));
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static Users.UserClaim LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
            ...
            userClaim = Users.UserClaim.Load(var);
            return userClaim;
        }
        ...
        public Users.UserClaim Clone(bool deep)
        {
            Users.UserClaim userClaim = new Users.UserClaim();
        ...
        public Users.UserClaim Clone()
        {
            Users.UserClaim localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(Users.UserClaim userClaim, bool deep)
        {
            if ((userClaim == null))
            {
                throw new System.ArgumentNullException("userClaim");
