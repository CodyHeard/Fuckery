...
namespace Users
{
    ...
    public partial class User : System.ICloneable, System.IComparable, System.IComparable<Users.User>, CodeFluent.Runtime.ICodeFluentCollectionEntity<string>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<Users.User>, Microsoft.AspNet.Identity.IUser<int>, Microsoft.AspNet.Identity.IUser
    {
        ...
        private Users.RoleCollection _roles;
        
        [System.NonSerializedAttribute()]
        private Users.UserClaimCollection _claims;
        
        [System.NonSerializedAttribute()]
        private Users.UserLoginCollection _logins;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public Users.RoleCollection Roles
        {
            get
            {
                if ((this._roles == null))
                {
                    ...
                    {
                        this._roles = new Users.RoleCollection(this);
                        return this._roles;
                    }
                    this._roles = Users.RoleCollection.LoadRolesUserByUser(this);
                }
                return this._roles;
            }
        }
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public Users.UserClaimCollection Claims
        {
            get
            {
                if ((this._claims == null))
                {
                    if (((this.Id == -1) 
                                || (this.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) == true)))
                    {
                        this._claims = new Users.UserClaimCollection(this);
                        return this._claims;
                    }
                    this._claims = Users.UserClaimCollection.LoadByUser(this);
                }
                return this._claims;
            }
        }
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public Users.UserLoginCollection Logins
        {
            get
            {
                if ((this._logins == null))
                {
                    if (((this.Id == -1) 
                                || (this.EntityState.Equals(CodeFluent.Runtime.CodeFluentEntityState.Created) == true)))
                    {
                        this._logins = new Users.UserLoginCollection(this);
                        return this._logins;
                    }
                    this._logins = Users.UserLoginCollection.LoadByUser(this);
                }
                return this._logins;
            }
        }
        ...
        int Microsoft.AspNet.Identity.IUser<System.Int32>.Id
        {
            get
            {
                return this.Id;
        ...
        string Microsoft.AspNet.Identity.IUser<System.Int32>.UserName
        {
            get
            {
                return this.UserName;
        ...
        public virtual bool Equals(Users.User user)
        {
            if ((user == null))
            {
                return false;
        ...
        internal void SaveRolesRelations()
        {
            ...
            for (b = enumerator.MoveNext(); b; b = enumerator.MoveNext())
            {
                ...
                Users.Role role = ((Users.Role)(entry.Key));
                            ...
                            == false)))
                {
                    ...
                    persistence.AddParameter("@Role_Id", role.Id, ((int)(-1)));
                ...
                else
                {
                    ...
                    persistence1.AddParameter("@Role_Id", role.Id, ((int)(-1)));
                    persistence1.AddParameter("@User_Id", this.Id, ((int)(-1)));
...
user = value as Users.User;
        ...
        public virtual int CompareTo(Users.User user)
        {
            if ((user == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = TennisClubLadder.Resources.Manager.GetStringWithDefault(culture, "Users.User.ExternalValidate", "Type \'Users.User\' cannot be validated.", null);
                }
            ...
            {
                string localValidate = TennisClubLadder.Resources.Manager.GetStringWithDefault(culture, "Users.User.UserName.NullException", "\'UserName\' property cannot be set to \'\' for type \'Users.User\'", null);
                CodeFluentPersistence.AddValidationError(results, localValidate);
            }
            if ((this.SecurityStamp == default(string)))
            {
                string localValidate1 = TennisClubLadder.Resources.Manager.GetStringWithDefault(culture, "Users.User.SecurityStamp.NullException", "\'SecurityStamp\' property cannot be set to \'\' for type \'Users.User\'", null);
        ...
        public static Users.User Load(int id)
        {
            if ((id == -1))
            {
                return null;
        ...
        public static Users.User LoadByUserName(string userName)
        {
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, false)]
        public static Users.User LoadByUserLoginInfo(string providerKey, string providerName)
        {
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, false)]
        public static Users.User LoadByEmail(string email)
        {
...
dictionary = values as System.Collections.IDictionary;
            ...
            Users.RoleCollection roles = null;
roles = values as Users.RoleCollection;
            if ((roles != null))
            {
                this._roles = roles;
                return;
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static Users.User LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
        ...
        public Users.User Clone(bool deep)
        {
            Users.User user = new Users.User();
        ...
        {
            Users.User localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(Users.User user, bool deep)
        {
            if ((user == null))
            {
                throw new System.ArgumentNullException("user");
